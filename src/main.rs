...
impl App {
    ...
    > {
        ...
        "videotestsrc pattern=ball is-live=true ! videoconvert ! vp8enc keyframe-max-dist=30 deadline=1 error-resilient=default ! rtpvp8pay pt=101 ! queue max-size-time=300000000 ! application/x-rtp,media=video,encoding-name=VP8,payload=101 ! webrtcbin. webrtcbin name=webrtcbin"
    )?;
